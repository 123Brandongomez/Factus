...
import { ThemeToggle } from '../atomos';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-200">Gestión de Facturas</p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-3 bg-blue-900/60 px-4 py-2 rounded-lg">
            ...
            <button
              ...
              className="flex items-center justify-center ml-2 p-2 text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors shadow"
              title="Cerrar sesión"
            >
              <LogOut size={18} />
            </button>
